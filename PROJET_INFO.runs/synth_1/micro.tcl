...
synth_design -top micro -part xc7a35ticpg236-1L
...
write_checkpoint -force -noxdef micro.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file micro_utilization_synth.rpt -pb micro_utilization_synth.pb"  } 
